...
import dev.ai4j.openai4j.Http11OpenAiClient;
...
public class Http11OpenAiChatModel implements ChatLanguageModel, TokenCountEstimator {

    private static final Logger log = org.slf4j.LoggerFactory.getLogger(Http11OpenAiChatModel.class);
    ...
    public Http11OpenAiChatModel(String baseUrl,
                                 String apiKey,
        ...
        this.client = Http11OpenAiClient.builder()
                .openAiApiKey(apiKey)
                .baseUrl(baseUrl)
    ...
    private Response<AiMessage> generate(List<ChatMessage> messages,
        ...
        if (responseFormat != null && responseFormat.type() == JSON_SCHEMA && responseFormat.jsonSchema() == null) {
            responseFormat = null;
        }
    ...
    public static class Builder {
        ...
        public Builder modelName(OpenAiChatModelName modelName) { this.modelName = modelName.toString(); return this; }
        ...
        public Builder strictJsonSchema(Boolean strictJsonSchema) { this.strictJsonSchema = strictJsonSchema; return this; }
        public Builder seed(Integer seed) { this.seed = seed; return this; }
        public Builder user(String user) { this.user = user; return this; }
        public Builder strictTools(Boolean strictTools) { this.strictTools = strictTools; return this; }
        ...
        public Builder tokenizer(Tokenizer tokenizer) { this.tokenizer = tokenizer; return this; }
        public Builder customHeaders(Map<String, String> customHeaders) { this.customHeaders = customHeaders; return this; }
        public Builder listeners(List<ChatModelListener> listeners) { this.listeners = listeners; return this; }

        public Http11OpenAiChatModel build() {
            return new Http11OpenAiChatModel(
                    this.baseUrl,
                    this.apiKey,
                    this.organizationId,
                    this.modelName,
